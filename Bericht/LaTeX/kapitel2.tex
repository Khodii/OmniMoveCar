...
\section{Smartphone als Augmented Reality Gerät}
Als Alternative zu den später verglichenen Augmented Reality Brillen, kann auch ein Smartphone \cite{link:vrodo_vergleich1} benutzt werden um Virtuelle Objekte in die Realität zu projizieren.
...
\cite{link:texniccenter2} verfügbar und bietet eine bequeme Oberfläche zum
Umgang mit \LaTeX.
...
Regel "`TeTeX"' oder auch "`LaTeX"'. Es enthält ähnlich wie
...
{\ttfamily TeXnicCenter}~\cite{link:texniccenter1,link:texniccenter2}. Beide Programme sind quasi "`aufgebohrte"' Texteditoren mit Schaltflächen zum direkten
...
Der Editor bietet Syntaxhighlighting für die verschiedenen
